      ...
      <div className="bike-details">
        ...
        <div style={{ marginTop: '15px', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#666' }}>
            ...
            <span>Max Speed: <strong>{bike.maximum_speed} km/h</strong></span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#666' }}>
            <MdRoute size={18} color="#C85A28" />
            <span>Max Distance: <strong>{bike.maximum_functional_distance} km</strong></span>
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#666' }}>
            <MdBuild size={18} color="#C85A28" />
            <span>Last Service: <strong>{formatDate(bike.last_service_date)}</strong></span>
          </div>
          {bike.current_hub && (
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '14px', color: '#666' }}>
              <span>🏠</span>
              <span>Current Hub: <strong>{bike.current_hub}</strong></span>
            </div>
          )}
        </div>
      </div>
